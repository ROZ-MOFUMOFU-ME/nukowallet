...
<meta name="description" content="wallet.nekonium.site is a free, open-source, client-side interface for generating Nekonium wallets &amp; more. Interact with the Nekonium blockchain easily &amp; securely. Double-check the URL ( .site ) before unlocking your wallet.">
...
<meta property="og:description" content="wallet.nekonium.site is a free, open-source, client-side interface for generating Nekonium wallets &amp; more. Interact with the Nekonium blockchain easily &amp; securely. Double-check the URL ( .site ) before unlocking your wallet." />
...
"logo":"https://myetherwallet.com/images/myetherwallet-logo-banner2.png","description": "wallet.nekonium.site is a free, open-source, client-side interface for generating Nekonium wallets &amp; more. Interact with the Nekonium blockchain easily &amp; securely. Double-check the URL ( .site ) before unlocking your wallet.","sameAs":["https://wallet.nekonium.site/"]}</script>
</head>
<body>
